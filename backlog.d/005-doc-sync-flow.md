...
## Oracle
- [ ] Trigger + agent defined in BB with its own scoped OpenRouter key and budget line.
- [ ] One week of runs: docs drift found and fixed via PRs on >=2 repos; cost within budget.
- [ ] Model choice justified by a crucible measurement (not vibes) once crucible runs.
